...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="<?= base_url('/perusahaan') ?>" class="logo d-flex align-items-center">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow messages">
            ...
            <li class="message-item">
              <a href="#">
                <img src="asset_admin/img/messages-1.jpg" alt="" class="rounded-circle">
                <div>
                  <h4>Maria Hudson</h4>
            ...
            <li class="message-item">
              <a href="#">
                <img src="asset_admin/img/messages-2.jpg" alt="" class="rounded-circle">
                <div>
                  <h4>Anna Nelson</h4>
                  <p>Velit asperiores et ducimus soluta repudiandae labore officia est ut...</p>
                  <p>6 hrs. ago</p>
            ...
            <li class="message-item">
              <a href="#">
                <img src="asset_admin/img/messages-3.jpg" alt="" class="rounded-circle">
                <div>
                  <h4>David Muldon</h4>
                  <p>Velit asperiores et ducimus soluta repudiandae labore officia est ut...</p>
                  <p>8 hrs. ago</p>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-heading">Tools Lowongan</li>

      <li class="nav-item">
        <a class="nav-link collapsed" href="<?= base_url('/perusahaan/tambahlowongan') ?>">
          <i class="bi bi-person"></i>
          <span>Membuat Lowongan</span>
        </a>
      </li>
      <!-- End Profile Page Nav -->

      <li class="nav-item">
        <a class="nav-link collapsed" href="<?= base_url('/perusahaan/status') ?>">
          <i class="bi bi-journal-medical"></i>
          <span>Status Lowongan</span>
        </a>
      </li><!-- End F.A.Q Page Nav -->


      </li><!-- End Contact Page Nav -->
      <li class="nav-heading">Tools Perusahaan</li>
      <li class="nav-item">
        <a class="nav-link collapsed" href="<?= base_url('/perusahaan/view') ?>">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="<?= base_url('perusahaan/atur-profile') ?>">
          <i class="bi bi-person"></i>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="<?= base_url('perusahaan/ubah-password') ?>">
          <i class="bi bi-gear"></i>
