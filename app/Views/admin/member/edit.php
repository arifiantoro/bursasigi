                    ...
                    <div class="card-body pb-0">
                        ...
                        <div class="d-flex flex-row my-2">
                            <div class="form-check mx-2 my-2">
                                <input class="form-check-input" type="radio" name="ijk" id="ijk1" <?php if ($member->jenis_kelamin == 'Laki - Laki') {
                                                                                                        echo "checked";
                            ...
                            <div class="form-check mx-2 my-2">
                                <input class="form-check-input" type="radio" name="ijk" id="ijk2" <?php if ($member->jenis_kelamin == 'Perempuan') {
                                                                                                        echo "checked";
    ...
    function saving() {
        ...
        $.ajax({
            ...
            data: {
                ...
                pekerjaan_dicari: document.getElementById('pekerjaan_dicari').value,
                jenisK: jenis,
