                    ...
                    <div class="card-body pb-0">
                        <div class="row align-items-center justify-content-center">
                            ...
                            <div class="col-4 text-end">
                                <button class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#modalId"><i class="bi bi-person-plus-fill"></i> Tambah Riwayat Pendidikan</button>
                            </div>
                        </div>
                            ...
                            <tbody>
                                ...
                                <?php foreach ($pendidikan as $p => $pendidikan) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-danger btn-sm" href="<?= base_url('/member/profile/delete/' . $pendidikan->id) ?>"><i class="bi bi-trash"></i> Hapus Data</a>
                                        </td>
                                    </tr>
                                <?php endforeach ?>
        ...
        <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-md" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="<?= base_url('/member/profile/riwayatPost') ?>" method="post">
                        <?= csrf_field() ?>
